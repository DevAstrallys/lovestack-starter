-- Insert test data for all database tables (corrected UUIDs)
...
-- 6. Buildings (legacy table) - corrected UUIDs
...
('o1111111-1111-1111-1111-111111111111', 'ca111111-1111-1111-1111-111111111111', 'Fuite d''eau', 'water_leak', '{"fr": "Fuite d''eau", "en": "Water leak"}'),
('o2222222-2222-2222-2222-222222222222', 'ca111111-1111-1111-1111-111111111111', 'WC bouché', 'blocked_toilet', '{"fr": "WC bouché", "en": "Blocked toilet"}'),
('o3333333-3333-3333-3333-333333333333', 'ca222222-2222-2222-2222-222222222222', 'Panne électrique', 'power_outage', '{"fr": "Panne électrique", "en": "Power outage"}'),
('o4444444-4444-4444-4444-444444444444', 'ca222222-2222-2222-2222-222222222222', 'Éclairage défaillant', 'faulty_lighting', '{"fr": "Éclairage défaillant", "en": "Faulty lighting"}'),
('o5555555-5555-5555-5555-555555555555', 'ca333333-3333-3333-3333-333333333333', 'Radiateur froid', 'cold_radiator', '{"fr": "Radiateur froid", "en": "Cold radiator"}'),
('o6666666-6666-6666-6666-666666666666', 'ca444444-4444-4444-4444-444444444444', 'Parties communes', 'common_areas', '{"fr": "Parties communes", "en": "Common areas"}'),
('o7777777-7777-7777-7777-777777777777', 'ca555555-5555-5555-5555-555555555555', 'Espaces verts', 'green_spaces', '{"fr": "Espaces verts", "en": "Green spaces"}');
...
('t1111111-1111-1111-1111-111111111111', 'b1111111-1111-1111-1111-111111111111', 
  ...
  NULL, NULL, 'ca111111-1111-1111-1111-111111111111', 'o1111111-1111-1111-1111-111111111111'),
...
('t2222222-2222-2222-2222-222222222222', 'b1111111-1111-1111-1111-111111111111',
  ...
  NULL, NULL, 'ca222222-2222-2222-2222-222222222222', 'o4444444-4444-4444-4444-444444444444'),
...
('t3333333-3333-3333-3333-333333333333', 'b2222222-2222-2222-2222-222222222222',
  ...
  NULL, NULL, 'ca444444-4444-4444-4444-444444444444', 'o6666666-6666-6666-6666-666666666666'),
...
('t4444444-4444-4444-4444-444444444444', 'b1111111-1111-1111-1111-111111111111',
  ...
  NULL, NULL, 'ca333333-3333-3333-3333-333333333333', 'o5555555-5555-5555-5555-555555555555');
